...
def _run_combos(cancer_name, cat1, cat2=None):
    ...
    if cat2 is None:
        ...
        test_units = itertools.product(cancer_combos[cat1], cancer_combos[cat2], 2)
    ...
    for source1, source2 in test_units:
        ...
        try:
            ...
            LOGGER.error(f"test failed! Unable to perform join on {source1[1]} and {source2[1]} for {cancer_name}.\n{e}")
            raise