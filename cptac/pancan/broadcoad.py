...
class BroadCoad(Dataset):
    ...
    def __init__(self, no_internet, version):
        ...
        data_files = {
            "1.0": [
                "Colon.rsem_transcripts_tpm.txt.gz",
        ...
        super().__init__(cancer_type="broadcoad", version=version, valid_versions=valid_versions, data_files=data_files, no_internet=no_internet)
        ...
        for file_path in self._data_files_paths: # Loops through files variable
            ...
            if file_name == "Colon.rsem_transcripts_tpm.txt.gz":
