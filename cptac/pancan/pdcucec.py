...
class PdcUcec(Dataset):
    ...
    def __init__(self, version="latest", no_internet=False):
        ...
        super().__init__(cancer_type="pdcucec", version=version, valid_versions=valid_versions, data_files=data_files, no_internet=no_internet, attempt_update_index=False)
        ...
        acetyl['Patient_ID'] = acetyl['aliquot_submitter_id'].replace(mapping_dict) # aliquots to patient IDs
