    ...
    def __init__(self, no_internet, version):
        ...
        data_files = {
            "1.0": [
                ...
                "ccRCC_precursor_miRNA_combined.tsv",
        ...
        mssmclin = MssmClinical(no_internet=no_internet, version="latest", filter_type='pancanccrcc') #_get_version - pancandataset
        ...
        for file_path in self._data_files_paths: # Loops through files variable
            ...
            elif file_name == "ccRCC_xCell.txt":
            ...
            elif file_name == "CIBERSORT.Output_Abs_ccRCC.txt":
                df = pd.read_csv(file_path, sep = '\t', index_col = 0) 
                df.index.name = 'Patient_ID'
                df.columns.name = 'Name'
