...
class DataSet:
    ...
    def how_to_cite(self):
        ...
        print("Citation for this data:\n'Data used in this publication were generated by the CPTAC consortium. Data was accessed through the cptac Python module, available at https://pypi.org/project/cptac/'")
