...
as a python list.
'''
def get_interacting_proteins(protein, num_results=25):
    string_list = get_interacting_proteins_string(protein, num_results)
    biogrid_list = get_interacting_proteins_biogrid(protein, num_results)
