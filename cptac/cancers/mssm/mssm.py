...
class Mssm(Source):
    ...
    def load_clinical(self):
        ...
        if df_type not in self._data:
            ...
            # Maybe use the save_df function here, but mssm is special and shouldn't need it
            self._data["clinical"] = df

                                 
        
        # TODO: Make load functions for all the convienient other ways of slicing up clinical data
