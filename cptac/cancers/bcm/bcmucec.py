    ...
    def __init__(self, version="latest", no_internet=False):
        ...
        self.data_files = {
            "1.0": {
                ...
                "circular_RNA" : "UCEC-circRNA_rsem_tumor_normal_UQ_log2(x+1)_BCM.txt",
                "transcriptomics" : "UCEC-gene_rsem_removed_circRNA_tumor_normal_UQ_log2(x+1)_BCM.txt"
            }
        }
        ...
        super().__init__(cancer_type="ucec", source='bcm', version=version, valid_versions=self.valid_versions, data_files=self.data_files, no_internet=no_internet)
