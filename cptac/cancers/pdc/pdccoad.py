...
class PdcCoad(Source):
    ...
    def __init__(self, version="latest", no_internet=False):
        ...
        super().__init__(cancer_type="coad", source='pdc', version=version, valid_versions=self.valid_versions, data_files=self.data_files, load_functions=self.load_functions, no_internet=no_internet)
