...
class PdcCoad(Source):
    ...
    def __init__(self, version="latest", no_internet=False):
        ...
        super().__init__(cancer_type="coad", source='pdc', version=version, valid_versions=self.valid_versions, data_files=self.data_files, load_functions=self.load_functions, no_internet=no_internet, attempt_update_index=False)
    ...
    def load_phosphoproteomics(self):
        ...
        if df_type not in self._data:
            ...
            df['Patient_ID'] = df['aliquot_submitter_id'].replace(mapping_dict) # replace label with Patient_IDs 
