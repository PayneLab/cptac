...
class PdcLuad(Cancer):
    ...
    def __init__(self, version="latest", no_internet=False):
        ...
        super().__init__(cancer_type="luad", source='pdc', version=version, valid_versions=self.valid_versions, data_files=self.data_files, no_internet=no_internet, attempt_update_index=False)
