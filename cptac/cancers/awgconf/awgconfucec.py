...
#             "not_used" : "UCEC_confirmatory_WGS_SV_tumor_v2.0.txt.gz",
    ...
    def load_CNV_log2ratio(self):
        ...
        # ALL THIS STUFF SHOULD THEORETICALLY BE TAKEN CARE OF WITH THE save_df FUNCTION
        # AND BY REPLACING Sample_Tumor_Normal WITH THE tissue_type PARAMETER ON THE GET FUNUCTIONS
...
#         # NOT NEEDED BC SAVE FUNCTION
#         # Call function from dataframe_tools.py to sort all tables first by sample status, and then by the index
#         #self._data = sort_all_rows(self._data)

#         # SAVE FUNCTION SHOULD PROBABLY DO THIS TOO
#         # Call function from dataframe_tools.py to standardize the names of the index and column axes
#         self._data = standardize_axes_names(self._data)


        
        # I don't think we need this anymore with the new way of doing things, but I could be wrong
