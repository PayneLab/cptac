...
## Requirements
This package is intended to run on Python 3.6 with pandas 0.23.4. It also requires numpy and wget. In the tutorials, we use seaborn 0.9.0 for data visualization. 
